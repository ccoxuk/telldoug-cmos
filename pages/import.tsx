    ...
    <div className={styles.container}>
      ...
      <header className={styles.header}>
        <div>
          ...
          <p className={styles.subtitle}>Bring your career history into TellDoug.</p>
        </div>
      </header>
      ...
      {!IMPORT_ENABLED ? (
        <div className={styles.content}>
          <div className={styles.instructionsCard}>
            <h3 className={styles.cardTitle}>Manual entry only (MVP)</h3>
            <p>
              LinkedIn import is intentionally disabled for the MVP so the data
              model stays clean and privacy‑first. Add your records manually to
              build the canonical timeline.
            </p>
