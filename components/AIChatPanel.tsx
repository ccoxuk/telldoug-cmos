...
export function AIChatPanel() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content:
        "Hi! I'm Doug. Ask about your jobs, skills, projects, people, or a specific year (ex: “What did I do in 2022?”).",
    },
  ]);
  ...
  const handleSubmit = async (e?: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch("/_api/tell-doug/query", {
        method: "POST",
      ...
      <div className={`${styles.panel} ${isOpen ? styles.open : ""}`}>
        ...
        <form className={styles.inputArea} onSubmit={handleSubmit}>
          <Input
            ...
            placeholder="Try: show my jobs, skills, projects, or 2022"
